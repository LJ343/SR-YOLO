...
if __name__ == '__main__':
    model = YOLO(r'YOLO11-SwinTransformer.yaml') # 续训yaml文件的地方改为lats.pt的地址,需要注意的是如果你设置训练200轮次模型训练了200轮次是没有办法进行续训的.
    ...
    model.train(data=data,
                ...
                project='runs/detect/Driving_v11SwinTransformer/train',
                name='exp',
                )
