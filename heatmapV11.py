...
def get_params():
    params = {
        'weight': 'runs/detect/Driving_v11SwinTransformer/train/exp2/weights/new_best.pt',  # 训练出来的权重文件
        'cfg': 'ultralytics/cfg/models/11/YOLO11-SwinTransformer.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
        'method': 'GradCAMPlusPlus',  # GradCAMPlusPlus, GradCAM, XGradCAM , 使用的热力图库文件不同的效果不一样可以多尝试
        'layer': 'model.model[12]',  # 想要检测的对应层
        'backward_type': 'all',  # class, box, all
        'conf_threshold': 0.3,  # 0.6  # 置信度阈值，有的时候你的进度条到一半就停止了就是因为没有高于此值的了
        'ratio': 0.05  # 0.02-0.1
    }
    return params
...
if __name__ == '__main__':
    ...
    model(r'E:/论文/YOLO系列/要用的数据/mobile detection.v1i.yolov11/valid/images/img_38703_jpg.rf.def66e46c3a0c767b9b848d52f7bdbaf.jpg', 'runs/heatmapv11Swim/drinking/GradCAMPlusPlus/small')  # 第一个是检测的文件, 第二个是保存的路径